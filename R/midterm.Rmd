...
### Compile and submit your work *(4 pts)*
...
Open the `midterm.html` file that will appear in the same directory as your 
`midterm.Rmd` file and check to make sure that the output looks correct.

Once you are sure that your work is correct and formatted correctly,
upload this file to the assignment named 'Midterm Exam (take-home)' on Canvas.